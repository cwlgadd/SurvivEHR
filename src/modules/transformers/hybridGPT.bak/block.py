...
import logging 
from CPRD.src.modules.transformers.hybridGPT.self_attention import MultiHeadedSelfAttention
from CPRD.src.modules.transformers.hybridGPT.mlp import MLP
...
class Block(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        hidden_size = cfg.transformer.n_embd
        attention_type = cfg.transformer.attention_type
        
        self.ln_1 = nn.LayerNorm(hidden_size, eps=layer_norm_epsilon)
        self.attn = MultiHeadedSelfAttention(cfg, attention_type=attention_type)
