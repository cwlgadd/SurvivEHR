...
class MultiHeadedSelfAttention(nn.Module):
    ...
    def __init__(self, 
        ...
        self.embed_dim = config.n_embd          #  Dimensionality of the encoder layers and the pooler layer.
        self.num_heads = config.n_head          # Number of attention heads for each attention layer in the Transformer encoder.
