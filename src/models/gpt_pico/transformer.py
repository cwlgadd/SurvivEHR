# Taken from https://colab.research.google.com/drive/1JMLa53HDuA-i7ZBmqV7ZnA3c_fvtXnx-?usp=sharing#scrollTo=hoelkOrFY8bN
# with additional resource https://github.com/karpathy/ng-video-lecture/tree/master
...
class GPTLanguageModel(nn.Module):
    ...
    def __init__(self, config, vocab_size):
        ...
        self.blocks = nn.Sequential(*[Block(config.n_embd,
                                            ...
                                            dropout=config.dropout) for _ in range(config.n_layer)])
