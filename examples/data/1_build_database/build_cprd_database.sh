...
#SBATCH --output=build_cprd_database_output.out
...
# 
echo "Build database from DeXTER output"
# cd /rds/homes/g/gaddcz/Projects/CPRD/examples/data/1_build_database/

# Execute your Python scripts
python build_cprd_database.py;