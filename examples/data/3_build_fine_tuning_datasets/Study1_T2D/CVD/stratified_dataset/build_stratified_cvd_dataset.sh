...
#SBATCH --output=build_stratified_cvd_dataset_output.out
...
# 
echo "Build sub-sampled fine-tuning dataset on T2D patients with cardiovascular disease outcomes, stratified by region within England"
cd /rds/homes/g/gaddcz/Projects/CPRD/examples/data/3_build_fine_tuning_datasets/Study1_T2D/CVD/stratified_dataset/

# Execute your Python scripts
python build_stratified_cvd_dataset.py;