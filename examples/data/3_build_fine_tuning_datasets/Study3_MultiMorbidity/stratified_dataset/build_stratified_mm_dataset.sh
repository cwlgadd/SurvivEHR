...
#SBATCH --output=build_stratified_mm_dataset_output.out
...
# 
echo "Build sub-sampled fine-tuning dataset on multi-morbidity example, stratified by region within England"
cd /rds/homes/g/gaddcz/Projects/CPRD/examples/data/3_build_fine_tuning_datasets/Study3_MultiMorbidity/stratified_dataset/

# Execute your Python scripts
python build_stratified_mm_dataset.py;