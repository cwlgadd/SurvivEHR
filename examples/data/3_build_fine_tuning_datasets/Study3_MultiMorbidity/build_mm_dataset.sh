...
#SBATCH --output=build_mm_dataset_output.out
...
# 
echo "Build fine-tuning dataset predicting future morbidities in 50 year old patients, from CPRD.db database of DeXTER output"
cd /rds/homes/g/gaddcz/Projects/CPRD/examples/data/3_build_fine_tuning_datasets/Study3_MultiMorbidity/

# Execute your Python scripts
python build_mm_dataset.py;